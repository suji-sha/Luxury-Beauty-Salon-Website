          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-brand-muted max-w-2xl mx-auto">
                From everyday pampering to bridal transformations — we have it
                all under one roof
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {/* 1. Hair Services */}
              <Card>
                <CardHeader className="bg-brand-secondary text-brand-text border-b-2 border-brand rounded-t-lg">
                ...
                <CardContent className="pt-6">
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2 text-brand-text">
                      <span className="text-brand-cta mt-1">✦</span>
              ...
              <Card>
                <CardHeader className="bg-brand-secondary text-brand-text border-b-2 border-brand rounded-t-lg">
                  <div className="flex items-center gap-3">
                    <div className="p-3 bg-white/30 rounded-full">
                      <Flower2 className="w-8 h-8 text-brand-accent" />
                    </div>
                    <CardTitle className="text-xl">
              ...
              <Card>
                ...
                <CardContent className="pt-6">
                  ...
                  <Separator className="my-6 bg-brand" />
                  <div className="text-center">
                    <Badge
                      variant="secondary"
                      className="bg-brand text-brand-text font-semibold"
                    >
                      Most Popular
                    </Badge>
                  </div>
